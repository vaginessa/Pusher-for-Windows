...
namespace Pusher
{
    ...
    public sealed partial class HubPage : Page
    {
        ...
        /// </summary>
        /// <param name="sender">Origine dell'evento clic.</param>
        /// <param name="e">Dettagli relativi all'evento clic.</param>
        ...
        /// </summary>
        /// <param name="sender">Origine dell'evento clic.</param>
        /// <param name="e">Valori predefiniti relativi all'evento clic.</param>
